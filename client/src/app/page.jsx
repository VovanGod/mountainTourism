		...
		<div className="homePage">
			...
			<div className="tip">
				...
				<div className="tip-content">
					<h3>Совет дня</h3>
					<p>
						При походе в горы всегда берите с собой запасной комплект теплой
						одежды. Погода в горах может резко измениться, и температура может
						упасть на 10-15 градусов за несколько часов.
					</p>
				</div>
			</div>
		</div>
